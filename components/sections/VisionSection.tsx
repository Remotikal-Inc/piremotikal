               ...
               <div className="mx-auto">
                    ...
                    <div className="grid gap-12">
                         <div>
                              ...
                              <p className="mt-3 dark:text-neutral-400 text-neutral-700 md:text-lg">
                         ...
                         <div className="space-y-6 lg:space-y-10">
                              ...
                              <div className="flex">
                                   ...
                                   <div className="ms-5 sm:ms-8">
                                        ...
                                        <p className="mt-1 dark:text-neutral-400 text-neutral-700 text-sm md:text-base lg:text-lg">
